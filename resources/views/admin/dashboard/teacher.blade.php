                  ...
                  <div class="box box-info">
                      ...
                      <div class="box-body">
                          <ul class="users-list clearfix">
                      		@foreach (array_slice($top_students, 0, 8) as $order => $student)
	                          	<li ng-repeat="student in dashboardData.studentLeaderBoard" class="ng-scope">
	                              <img alt="Alice Bean" class="user-image img-circle" style="width:35px; height:35px;" ng-src="dashboard/profileImage/14" src="/./img/<?php if($order==0) {echo "top_student.jpg";} else {echo "profile.jpg";} ?>">
